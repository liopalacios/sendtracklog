...
public class TracklogServiceImpl implements TracklogService {
    ...
    public void sendTracklogByMinute(String format) {
        ...
        List<Object[]> objects = alertaActivaRepository.getListEventsByMinute(format);
    ...
    private List<RequestTracklog> converterObjectToPojo(List<Object[]> objects) {
        ...
        for(Object[] obj : objects){
            ...
            requestTracklog.setEvento((int)obj[5]);
            requestTracklog.setVelocidad((Double)obj[6]);
            requestTracklog.setDireccion((Double) obj[7]);
